const divisionData = [
  ...
  },
  {
    ...
    numPlayoffRelegate: 1,
    numAutoRelegate: 0,
    players: ["Johann", "Yusif", "Remmy", "eggmaster", "Koolio", "Anomalous"]
  },
  {
    divisionName: "5B",
    numWinner: 0,
    ...
    numPlayoffRelegate: 1,
    numAutoRelegate: 0,
    players: ["Michu", "Mack", "Rhubarb", "Reykon", "ALEX_H", "Enigma"]
  },
  {
    divisionName: "5C",
    numWinner: 0,
...

  {
    ...
    numPlayoffRelegate: 1,
    numAutoRelegate: 0,
    players: ["Owen", "empty", "mil0-", "Samantha", "odinn", "Tupper", "wike"]
  },
  {
    divisionName: "7B",
    numWinner: 0,
...
const adminRole = ["GregBoomCannon#4087", "moodeuce#8573", "Kingsman#0364", "Tugi#7004"];
